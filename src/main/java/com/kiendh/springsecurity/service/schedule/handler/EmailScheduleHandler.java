...
@Setter
@Service
public class EmailScheduleHandler implements TaskStrategy {

    private TaskDefinition taskDefinition;

    @Override
    public void run() {
        log.info("Send email schedule with cron: {}", taskDefinition.getCronExpression());
    }
